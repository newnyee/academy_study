...
public class Test05_conversion {
    public static void main(String[] args) {
        ...
        System.out.println((int)'A'); //아스키코드 65
        System.out.println((int)'B'); //아스키코드 66
        System.out.println((int)'C'); //아스키코드 67

        System.out.println((int)'a'); //아스키코드 97
        System.out.println((int)'b'); //아스키코드 98
        System.out.println((int)'c'); //아스키코드 99
