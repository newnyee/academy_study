...
class Jumin {
    ...
    public void disp() {
        ...
        String[] animals = {"원숭이", "닭", "개", "돼지", "쥐", "소", "호랑이", "토끼", "용", "뱀", "말", "양"}; //띠 출력에 사용
        int year = 0;
        String sex = "";
        int age = 0;
        ...
        if(juminNo.charAt(6) == '1' || juminNo.charAt(6) == '2') { //1900년대생인지 확인
            year = Integer.parseInt(19 + juminNo.substring(0, 2)); //연도 포멧 4자리로 변경
            ...
            year = Integer.parseInt(20 + juminNo.substring(0,2)); //연도 포멧 4자리로 변경
