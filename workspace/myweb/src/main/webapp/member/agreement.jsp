...
<%@ include file="../header.jsp"%>
    ...
    <!--회원가입 약관 동의-->
    <div style="text-align: center"><h3 style="margin-bottom: 0"> 회원 약관 </h3></div>
    <br>
    <!--
    ...
    <table border="0" cellspacing="0" cellpadding="2"  align="center">
        <tr align="center" height="10">
            <td>
                <textarea cols="55" rows="14" readonly style="resize: none" class="form-control">Community 서비스약관 (2005. 7. 18 부터 유효)
...
본 약관은 2005. 7. 18. 부터 적용하고, 2004. 10. 11.부터 적용되던 종전의 약관은 본 약관으로 대체합니다.
    ...
    <div style="text-align: center; padding-bottom: 30px;">
      <label><input type="checkbox" name="agree" id="agree">약관에 동의합니다</label><br>
