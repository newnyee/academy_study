...
<%@ page import="main.java.net.pds.*"%>
<%@ page import="main.java.net.utility.*" %>

<jsp:useBean id="dao" class="main.java.net.pds.PdsDAO" scope="page"></jsp:useBean>
<jsp:useBean id="dto" class="main.java.net.pds.PdsDTO" scope="page"></jsp:useBean>
